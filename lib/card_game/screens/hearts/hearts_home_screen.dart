              ...
              Flexible(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildGuideSection(l10n.heartsGuideObjectiveTitle, l10n.heartsGuideObjective, Icons.info_outline, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.heartsGuideHowToPlayTitle, l10n.heartsGuideHowToPlay, Icons.play_arrow, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.heartsGuideScoringTitle, l10n.heartsGuideScoring, Icons.calculate, titleSize, textSize, Colors.pink),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.heartsGuideBreakingTitle, l10n.heartsGuideBreaking, Icons.favorite, titleSize, textSize, Colors.red),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.heartsGuideShootMoonTitle, l10n.heartsGuideShootMoon, Icons.star, titleSize, textSize, Colors.amber),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.heartsGuideTipsTitle, l10n.heartsGuideTips, Icons.lightbulb, titleSize, textSize, Colors.cyan),
                    ],
                  ),
                ),
              ),
