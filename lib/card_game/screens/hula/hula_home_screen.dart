              ...
              Flexible(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildGuideSection(l10n.hulaGuideObjectiveTitle, l10n.hulaGuideObjective, Icons.info_outline, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.hulaGuideHowToPlayTitle, l10n.hulaGuideHowToPlay, Icons.play_arrow, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.hulaGuideMeldTypesTitle, l10n.hulaGuideMeldTypes, Icons.style, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.hulaGuideSevenRuleTitle, l10n.hulaGuideSevenRule, Icons.star, titleSize, textSize, Colors.amber),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.hulaGuideThankYouTitle, l10n.hulaGuideThankYou, Icons.celebration, titleSize, textSize, Colors.cyan),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.hulaGuideStopTitle, l10n.hulaGuideStop, Icons.stop_circle, titleSize, textSize, Colors.red),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.hulaGuideCardPointsTitle, l10n.hulaGuideCardPoints, Icons.style, titleSize, textSize),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.hulaGuideScoringTitle, l10n.hulaGuideScoring, Icons.calculate, titleSize, textSize, Colors.lightGreenAccent),
                      const SizedBox(height: 16),
                      _buildGuideSection(l10n.hulaGuideStopPenaltyTitle, l10n.hulaGuideStopPenalty, Icons.warning, titleSize, textSize, Colors.orange),
                    ],
                  ),
                ),
              ),
