...
class L10n {
  static final Map<GameLanguage, Map<String, String>> _strings = {
    ...
    GameLanguage.japanese: {
      ...
      'info': '情報',
      'aboutTitle': 'アプリ紹介',
      'aboutContent': '様々なゲームを楽しめる無料ゲームコレクションアプリです。\n\n【囲碁】\n• AI対局、二人対局、詰碁問題\n\n【将棋】\n• AI対局、二人対局\n\n【カードゲーム】\n• マイティ、フラ、ハーツ、ワンカード、ハイロー、セブンポーカー\n\n【ボードゲーム】\n• 数独、キラー数独、テトリス、マインスイーパー\n• 五目並べ、オセロ、ソリティア、迷路、バブル\n\n【伝統ゲーム】\n• ユンノリ\n\nすべてのゲームはオフラインで無料でプレイできます。',
      'helpTitle': '遊び方',
      'helpRules': '基本ルール',
